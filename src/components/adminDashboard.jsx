                    ...
                    <ul className="navbar-nav">
                        <li className="nav-item bg-primary">
                            <a href="#!" className="nav-link text-light fs-5">
                                <span className="badge bg-dark"> <span className="bi bi-person-fill"></span> </span>  &nbsp;
                                {cookies.Adminname}
                            </a>                        </li>
                        <li className=" nav-item">
                            <Link to="/addVideo" className="btn btn-success mx-2 nav-link text-light" title="Add New Videos">
                                <span className="bi bi-cloud-plus fs-4 m-1 my-sm-2" ></span>
                            </Link>
                        </li>
                        <li className="nav-item">
                            <button onClick={RemoveCookie} className="nav-link text-light signOut">
